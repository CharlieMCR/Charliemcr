...
<nav class="group nav" id="primary_nav">
    ...
    <ul class="">
        <li class="about"><a href="/userpanel/dashboard">Projects</a></li>
        <li class="cv"><a href="/userpanel/dashboard/create">Create</a></li>
        <li class="cv"><a href="/users/logout">Logout</a></li>
